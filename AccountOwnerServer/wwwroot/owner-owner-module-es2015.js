...
let OwnerCreateComponent = class OwnerCreateComponent {
    ...
    executeOwnerCreation(ownerFormValue) {
        let owner = {
...
OwnerCreateComponent.ctorParameters = () => [
...
let OwnerDeleteComponent = class OwnerDeleteComponent {
    constructor(repository, errorHandler, router, activeRoute) {
        this.repository = repository;
        this.errorHandler = errorHandler;
        this.router = router;
    ...
    deleteOwner() {
        let deletUrl = `api/owner/${this.owner.id}`;
...
OwnerDeleteComponent.ctorParameters = () => [
...
let OwnerDetailsComponent = class OwnerDetailsComponent {
    constructor(repository, router, activeRoute, errorHandler) {
        this.repository = repository;
        this.router = router;
        this.activeRoute = activeRoute;
        this.errorHandler = errorHandler;
...
let OwnerUpdateComponent = class OwnerUpdateComponent {
    constructor(repository, errorHandler, activeRoute, router, datePipe) {
        this.repository = repository;
        this.errorHandler = errorHandler;
        this.activeRoute = activeRoute;
        this.router = router;
...
OwnerUpdateComponent.ctorParameters = () => [
    { type: src_app_services_repository_service__WEBPACK_IMPORTED_MODULE_3__["RepositoryService"] },
    { type: src_app_services_error_handler_service__WEBPACK_IMPORTED_MODULE_4__["ErrorHandlerService"] },
...
//# sourceMappingURL=owner-owner-module-es2015.js.map